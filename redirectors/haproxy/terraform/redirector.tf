...
resource "aws_instance" "redirector" {
  ...
  provisioner "local-exec" {
    command = <<EOT
      ...
      -e c2_ip=${var.c2_ip} \
      -e listenning_port_http=${var.listenning_port_http} \
      -e c2_port_http=${var.c2_port_http} \
      -e listenning_port_https=${var.listenning_port_https} \
      -e c2_port_https=${var.c2_port_https} \
